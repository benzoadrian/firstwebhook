...
OPENAI_API_KEY = "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"  # Add your OpenAI API key
                ...
                for entry in data['entry']:
                    ...
                    for change in changes:
                        ...
                        for message in messages:
                            ...
                            # Get response from OpenAI using the new API method for completions
                            response = openai.Completion.create(
                                model="text-davinci-003",  # Or any model you prefer (e.g., "gpt-3.5-turbo" if available)
                                prompt=text,
